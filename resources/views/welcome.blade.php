...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5">
        <a href="index.html" class="navbar-brand d-flex align-items-center">
            <h1 class="m-0"><img class="img-fluid " src="{{ asset('frontend/img/logo.png') }}" alt="logo"
                    alt=""></h1>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav mx-auto pe-4 py-3 py-lg-0">
                ...
                <div class="dropdown">
                    <a href="{{ route('service') }}" class="dropbtn nav-item nav-link">Our Services <i
                    ...
                    <div class="timeline">
                        <div class="timeline-item timeline-item-start d-flex pb-3">
                            ...
                            <div class="flex-shrink-1 d-flex align-items-center me-3">
                                <div
                                    class="timeline-circle rounded-circle text-white d-flex align-items-center justify-content-center">
                                    1</div>
                            </div>
                                ...
                                <div class="timeline-box rounded-4 p-3">
                                    ...
                                    <p>
                                        ...
                                        <font>
                                            ...
                                            Clients choose us with confidence for several compelling reasons."
                                        </font>
                        ...
                        <div class="timeline-item d-flex pb-3">
                            ...
                            <div class="flex-grow-1">
                                <div class="timeline-box rounded-4 p-3">
                                    ...
                                    <p>
                                        <font>
                                            "At our service center, we take pride in offering top-notch solutions at a
                                            reasonable price."
                                        </font>
                                        <button class="choos-btn">Read more..</button>
                                    </p>
                        ...
                        <div class="timeline-item timeline-item-end d-flex pb-3">
                            ...
                            <div class="flex-grow-1">
                                <div class="timeline-box rounded-4 p-3">
                                    ...
                                    <p>
                                        <font>
                                            "Our 24/7 support is designed with your convenience in mind, providing peace
        ...
        <div class="row owl-carousel-row">
            <div class="owl-carousel owl-theme">
                <div>
                    <div>
                        <a href="aeon.html">
                            <img src="{{ asset('frontend/img/aeon.png') }}" alt="aeon"
                ...
                <div>
                    <div>
                        <a href="pos.html">
                            <img src="{{ asset('frontend/img/pos.png') }}" alt="pos"
                                class="card-img-top img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div>
                    <div>
                        <a href="misi.html">
                            <img src="{{ asset('frontend/img/misilogo.png') }}" alt="misi"
                                class="card-img-top img-fluid">
                        </a>
                    </div>
                </div>
                                    ...
                                    <div class="flip-box-inner">
                                        <div class="flip-box-front">
                                            <img class="img-service"
                                                src="{{ asset('frontend/img/service/Software Development1.jpg') }}"
                                                alt="Paris">
                                        </div>
                                        <div class="flip-box-back">
                                            <img class="img-service"
                                                src="{{ asset('frontend/img/service/Software Development.jpg') }}"
                                                alt="Paris">
                                            <div class="flip-text">
                                                <h2>Dream Diver</h2>
                            ...
                            <a href="mobile-app.html">
                                <div class="flip-box">
                                    <div class="flip-box-inner">
                                        <div class="flip-box-front">
                                            <img class="img-service"
                                                src="{{ asset('frontend/img/service/Mobile App Development.jpg') }}"
                                                alt="Paris">
                                        </div>
                                        <div class="flip-box-back">
                                            <img class="img-service"
                                                src="{{ asset('frontend/img/service/Mobile App Development1.jpg') }}"
                                                alt="Paris">
                                            <div class="flip-text">
                            ...
                            <a href="software-services.html">
                                <div class="flip-box">
                                    <div class="flip-box-inner">
                                        <div class="flip-box-front">
                                            <img class="img-service"
                                                src="{{ asset('frontend/img/service/Software Services.jpg') }}"
                                                alt="Paris">
                                        </div>
                                        <div class="flip-box-back">
                                            <img class="img-service"
                                                src="{{ asset('frontend/img/service/Software Services1.jpg') }}"
                                                alt="Paris">
                                            <div class="flip-text">
                                                <h2>Dream Diver</h2>
                            ...
                            <a href="web-design.html">
                                <div class="flip-box">
                                    <div class="flip-box-inner">
                                        <div class="flip-box-front">
                                            <img class="img-service"
                                                src="{{ asset('frontend/img/service/Web_Design.jpg') }}"
                                                alt="Paris">
                                        </div>
                                        <div class="flip-box-back">
                                            <img class="img-service"
                                                src="{{ asset('frontend/img/service/Web_Design1.jpg') }}"
                                                alt="Paris">
                                            <div class="flip-text">
                                                <h2>Dream Diver</h2>
                            ...
                            <a href="seo.html">
                                <div class="flip-box">
                                    <div class="flip-box-inner">
                                        <div class="flip-box-front">
                                            <img class="img-service"
                                                src="{{ asset('frontend/img/service/seo.jpg') }}" alt="Paris">
                                        </div>
                                        <div class="flip-box-back">
                                            <img class="img-service"
                                                src="{{ asset('frontend/img/service/seo1.jpg') }}" alt="Paris">
                                            <div class="flip-text">
                                                <h2>Dream Diver</h2>
                            ...
                            <a href="marketing.html">
                                <div class="flip-box">
                                    <div class="flip-box-inner">
                                        <div class="flip-box-front">
                                            <img class="img-service"
                                                src="{{ asset('frontend/img/service/Digital_Marketing.jpg') }}"
                                                alt="Paris">
                                        </div>
                                        <div class="flip-box-back">
                                            <img class="img-service"
                                                src="{{ asset('frontend/img/service/Digital_Marketing1.jpg') }}"
                                                alt="Paris">
                                            <div class="flip-text">
                                                <h2>Dream Diver</h2>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p><i class="fa fa-map-marker-alt me-3"></i>Weena zuid 130, ext 405, 3012 NC Rotterdam,
                        Netherlands.</p>
                    <a href="tel:+31644215009" style="color: #7A8499;"><i
                            class="fa fa-phone-alt me-3"></i>+31644215009</a><br>
                    <a href="mailto:info@dreamdiver.nl" style="color: #7A8499;"><i
                            class="fa fa-envelope me-3"></i>info@dreamdiver.nl</a>
                </div>
                <div class="col-lg-3 col-md-6">
    ...
    <!-- whatsapp -->
    <a href="https://web.whatsapp.com/send?phone=+31644215009text=Hi,%20How%20can%20i%20help%20you?" target="_blank"
        class="whatsapp_float"><i class="bi bi-whatsapp whatsapp-icon-bi"></i></a>
    <!-- Back to Top -->
